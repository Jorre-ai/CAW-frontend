...
export class FakeBackendInterceptor implements HttpInterceptor {
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
        ...
        function getUsers() {
            ...
            return ok(users.map((x: { id: any; username: any; firstName: any; lastName: any; }) => basicDetails(x)));
        }
        ...
        function ok(body?: { token?: string; id: any; username: any; firstName: any; lastName: any; }) {
